Apistagram::Application.routes.draw do
  ...
  match "cakesta/:category"         => 'iphotos#index'
  match "cakesta/:category/:sort"   => 'iphotos#index' 
  match "tattsta/:category"         => 'iphotos#index'
  match "tattsta/:category/:sort"   => 'iphotos#index'
  match "tatstagram/:category"         => 'iphotos#index'
  match "tatstagram/:category/:sort"   => 'iphotos#index'     
